...
public:
  ...
  friend inline FXfloat len2(const FXVec3f& a);
  friend inline FXfloat len(const FXVec3f& a);
...
inline FXfloat len2(const FXVec3f& a){ return a.x*a.x+a.y*a.y+a.z*a.z; }
inline FXfloat len(const FXVec3f& a){ return sqrtf(len2(a)); }

extern FXAPI FXVec3f normalize(const FXVec3f& a);
