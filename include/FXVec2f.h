...
public:
  ...
  friend FXAPI FXfloat len2(const FXVec2f& a);
  friend FXAPI FXfloat len(const FXVec2f& a);

  /// Normalize vector
  friend FXAPI FXVec2f normalize(const FXVec2f& a);

  /// Lowest or highest components
  friend FXAPI FXVec2f lo(const FXVec2f& a,const FXVec2f& b);
  friend FXAPI FXVec2f hi(const FXVec2f& a,const FXVec2f& b);
...
inline FXfloat len2(const FXVec2f& a){ return a.x*a.x+a.y*a.y; }
inline FXfloat len(const FXVec2f& a){ return sqrtf(len2(a)); }

extern FXAPI FXVec2f normalize(const FXVec2f& a);
